...
import { Config } from 'src/ressources';
...
export class RegisterComponent implements OnInit {
  ...
  constructor( private authService: AuthService, private fb: FormBuilder, protected forms: FormFactory, protected snackBar: MatSnackBar) {}
