...
public class UserDetails extends User {
     ...
     */
    public UserDetails(dev.louiiuol.jarit.business.entities.User user) {
      super(user.getUsername(), user.getPassword(), user.getEnabled(), user.getAccountNonExpired(),
        user.getCredentialsNonExpired(), user.getAccountNonLocked(), buildAuthorities(user.getRoles()));
      id = user.getId();
