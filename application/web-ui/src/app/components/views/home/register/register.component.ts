...
export class RegisterComponent implements OnDestroy {
  ...
  private registerGroup = (): any => ({ username: UserForm.username, email: UserForm.email,
    birthDate: UserForm.birthDate, passwordForm: PasswordRequiredForm, agree: UserForm.agree
  })
