...
export class LoginComponent implements OnDestroy {
  ...
  private destroyed$ = new Subject(); // Subject to unsubscribe to all present Subscription at once
    ...
    readonly errorMessages = ErrorMessages.user;
    ...
    private credentials = (username: AbstractControl, password: AbstractControl): AuthLogin =>
        new AuthLogin(username.value, password.value)
