...
export class UserProfileComponent implements OnDestroy {
  ...
  constructor(private authService: AuthService, private userService: UserService, private forms: FormFactory) {
    this.init();
  }
  ...
  private handleUpdateSuccess(pass: string): void {
    this.authService.reloadToken(new AuthLogin(this.username.value, pass), false).subscribe(() => {
